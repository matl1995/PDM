...
public class Formas2Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_formas2);
        ...
        formaCorrecta.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent=new Intent(Formas2Activity.this,AcertasteActivity.class);
        ...
        formaErronea1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent=new Intent(Formas2Activity.this,FallasteActivity.class);
                startActivity(intent);
                finish();
            }
        });
