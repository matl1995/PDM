...
public class Colores1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button colorCorrecto=(Button) findViewById(R.id.color3_button);
        colorCorrecto.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent=new Intent(Colores1Activity.this,AcertasteActivity.class);
        ...
        colorErroneo1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent=new Intent(Colores1Activity.this,FallasteActivity.class);
                startActivity(intent);
                finish();
            }
        });
