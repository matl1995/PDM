    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                {
                    Intent i = new Intent(FallasteActivity.this, ColoresActivity.class);
                    startActivity(i);
                    finish();
                }
                else if(nivel.compareTo("2")==0)
                {
                    Intent i = new Intent(FallasteActivity.this, Colores1Activity.class);
                    startActivity(i);
                    finish();
                }
                else if(nivel.compareTo("3")==0)
                {
                    Intent i = new Intent(FallasteActivity.this, Colores2Activity.class);
                    startActivity(i);
                    finish();
                }
            }
